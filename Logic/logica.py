def Calcualar(elementos, calorias_minimas, peso_maximo):
    mejor_conjunto = None
...
def elementosCalcular(calorias_minimas, peso_maximo):
    # Ejemplo de uso
    elementos = [
    ...
    conjunto_optimo = Calcualar(elementos, calorias_minimas, peso_maximo)
